...
INSERT INTO collane (id, nome, descrizione) VALUES
  (1, "Il Signore degli Anelli", "Romanzo fantasy ambientato nella terra di mezzo. Parla di un Hobbit che deve distruggere un anello per portare la pace.");
INSERT INTO collane (id, nome, descrizione) VALUES
  (2, "Harry Potter", "Ogni libro della serie rappresenta un anno nella vita di Harry dagli undici ai diciassette anni; i libri descrivono ogni anno scolastico trascorso nella scuola di magia e stregoneria di Hogwarts.");
...
INSERT INTO utenti (id, cognome, nome, data_nascita, citta, indirizzo)
VALUES (1, "Cortesi", "Emanuele", "1996-09-30", "Bagnacavallo (RA)", "via aaa 1");
INSERT INTO utenti (id, cognome, nome, data_nascita, citta, indirizzo)
VALUES (2, "Capucci", "Fabio", "1996-01-16", "Fusignano (RA)", "via bbb 2");
