...
$record = $connessione->select('personale', '*', 'WHERE id=' . $_GET['id']);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $risultato = $connessione->update('personale', [
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3>Modifica Personale</h3>
    <a href="index.php" class="btn btn-link">Lista personale</a>
</div>
